...
```javascript
without = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-without@v0.1.1-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/array-base-without/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/array-base-without/actions/workflows/test.yml?query=branch:v0.1.1
